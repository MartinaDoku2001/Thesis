...
\begin{equation}
\text{RRMSE} = \frac{\text{RMS}(f(x)-x)}{\text{RMS}(x)}
\end{equation}
where RMS is:
\begin{equation}
...
\begin{thebibliography}{1}
    ...
    \bibitem{GAN model}{An, Y.; Lam, H.K.; Ling, S.H. Auto-Denoising for EEG Signals Using Generative Adversarial Network. Sensors 2022, 22, 1750. https://doi.org/10.3390/s22051750}    
