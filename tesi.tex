...
\end{itemize}
 ...
 Normalization layer and residual connections are applied after every block.
  The output of transformer encoder is reshaped into one dimension as the
   final output. 
\subsection{Trnasformer-GRU}\label{sec:model_transformer_gru}
...
\hline
\textbf{\hyperref[sec:model_transformer_fcnn]{Transformer FCNN}} & 0.0000 & 1.0000 & 100.0000 & 1.0000 & 0.0000 & 1.0000 & 100.0000 & 1.0000 \\
\hline
\textbf{\hyperref[sec:model_transformer_gru]{Transformer GRU}} & 0.0000 & 1.0000 & 100.0000 & 1.0000 & 0.0000 & 1.0000 & 100.0000 & 1.0000 \\
\hline
