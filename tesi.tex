...
The output of the attention mechanisms is further processed by a ResBiGruBlock and a 
...
that addresses the issue of "dying ReLU" neurons. It introduces a 
...
complex patterns, the ResBiGru layer is repeated two times. This 
...
The model trains for a total of 110 epochs on EOG contaminated data and
...
The specific value of 110 and 100 epochs was chosen based experimentations
 and may vary depending on the model, the dataset and the specific
 values of the hyperparameters.\newline \\
The optimizer that is used during the training is an Adam optimizer.
...
\end{itemize}
The specific values of the hyperparameters are set as follows:
...
hyperparameters.\newline \\
The loss function that is used during the training is the mean
...
\begin{thebibliography}{1}
    \bibitem{waves type}{Torres, E.P.; Torres, E.A.; Hernández-Álvarez, M.; Yoo, S.G. EEG-Based BCI Emotion Recognition: A Survey. Sensors 2020, 20, 5083. https://doi.org/10.3390/s20185083}
