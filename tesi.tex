...
of signals. We will start with the definition of a signal and we will
present the main methods used for the analysis of general signals that 
constituted a base for the methods used for the analysis of EEG data.
